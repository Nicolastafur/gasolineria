...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="bloque1">
            ...
            <ul>
                <a href="../Tabla/servicio_administrador.php">Servicios</a>
            </ul>
        </div>
        ...
        <div class="bloque2">
            ...
            <ul>
                <a href="../Tabla/tipo_vehiculo_administrador.php">Tipo de vehiculo</a>
            </ul>
        </div>
        ...
        <div class="bloque5">
            ...
            <ul>
                <a href="../tabla/tipo_usu.php">Tipo de usuarios</a>
            </ul>
        </div>
